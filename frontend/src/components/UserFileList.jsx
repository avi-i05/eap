...
const UserFileList = ({ refreshFlag }) => { // Get refresh flag
  ...
  useEffect(() => {
    fetchUserFiles(); // Refetch files when refreshFlag changes
  }, [refreshFlag]);
  ...
  const handleDelete = async (fileId) => {
    ...
    try {
      ...
      // Auto refresh by triggering the parent refresh flag (by calling fetchUserFiles again)
      fetchUserFiles();
            ...
            >
              ...
              <div className="file-actions">
                <button
                  ...
                  onClick={(e) => { e.stopPropagation(); handleDownload(file._id, file.fileName); }}
                >
                  Download
                </button>
                <button
